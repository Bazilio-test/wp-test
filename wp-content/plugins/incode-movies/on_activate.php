...
function populate_demo_data(){
	...
	$films = [
		['name' => 'Бойцовский клуб', 'year' => 1999, 'country' => 'США', 'price' => 360, 'genres' => ['триллер', 'драма', 'криминал'], 'actors' => ['Эдвард Нортон', 'Брэд Питт', 'Хелена Бонем Картер', 'Мит Лоаф', 'Зэк Гренье', 'Холт МакКэллани'], 'content' => 'Терзаемый хронической бессонницей и отчаянно пытающийся вырваться из мучительно скучной жизни, клерк встречает некоего Тайлера Дардена, харизматического торговца мылом с извращенной философией. Тайлер уверен, что самосовершенствование — удел слабых, а саморазрушение — единственное, ради чего стоит жить.
...
register_activation_hook(INCODE_MOVIES__PLUGIN, 'incode_movies_plugin_activate');
